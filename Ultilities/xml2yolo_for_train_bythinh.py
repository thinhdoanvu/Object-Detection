...
# 📂 Paths
xml_dir = r"F:\users\thanh\ntu_group\thinh\ObjectDetection\datasets\Pest24v2\voc2007\voc2007\xmlval"   # folder containing XML files
txt_dir = r"F:\users\thanh\ntu_group\thinh\ObjectDetection\datasets\Pest24v2\voc2007\voc2007\txtval"   # output folder for YOLO txt
class_file = r"F:\users\thanh\ntu_group\thinh\ObjectDetection\datasets\Pest24v2\voc2007\voc2007\classname.txt"

os.makedirs(txt_dir, exist_ok=True)

# Store all classes found
all_classes = []
...
# Save class names to classname.txt
